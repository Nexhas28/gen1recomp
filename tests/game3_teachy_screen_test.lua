...
do
  ...
  -- pokefirered/src/teachy_tv.c:122 sBgTemplates[1].priority = 0
...
do
  ...
  Bag.add(s.bag, 289, 1)
  -- pokefirered/include/constants/items.h:143 ITEM_ORAN_BERRY (139)
  Bag.add(s.bag, 139, 2)
  Bag.add(s.bag, 13, 3)
...
do
  ...
  -- pokefirered/src/item_menu.c:2391 exitCB = Pokedude_InitTMCase
  ...
  -- pokefirered/src/tm_case.c:1422 gPokedudeText_TMTypes
